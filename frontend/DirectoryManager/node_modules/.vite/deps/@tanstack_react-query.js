...
var QueriesObserver = class extends Subscribable {
	...
	#notify() {
		if (this.hasListeners()) {
			if (this.#combinedResult !== this.#combineResult(this.#result, this.#options?.combine)) notifyManager.batch(() => {
				this.listeners.forEach((listener) => {
...
function dehydrate(client, options = {}) {
	...
	return {
		mutations,
		queries: client.getQueryCache().getAll().flatMap((query) => filterQuery(query) ? [dehydrateQuery(query, serializeData)] : [])
	};
}
