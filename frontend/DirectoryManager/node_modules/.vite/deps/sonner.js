...
var Ct = (s) => {
	switch (s) {
		...
		case "error": return Ut;
		default: return null;
	}
}, Ft = Array(12).fill(0), It = ({ visible: s }) => import_react.createElement("div", {
	className: "sonner-loading-wrapper",
	"data-visible": s
}, import_react.createElement("div", { className: "sonner-spinner" }, Ft.map((o, t) => import_react.createElement("div", {
	className: "sonner-loading-bar",
	key: `spinner-bar-${t}`
})))), $t = import_react.createElement("svg", {
	...
	clipRule: "evenodd"
})), Wt = import_react.createElement("svg", {
	xmlns: "http://www.w3.org/2000/svg",
	viewBox: "0 0 24 24",
	fill: "currentColor",
	height: "20",
	...
	clipRule: "evenodd"
})), _t = import_react.createElement("svg", {
	xmlns: "http://www.w3.org/2000/svg",
	viewBox: "0 0 20 20",
	fill: "currentColor",
	height: "20",
	...
	clipRule: "evenodd"
})), Ut = import_react.createElement("svg", {
	xmlns: "http://www.w3.org/2000/svg",
	viewBox: "0 0 20 20",
	fill: "currentColor",
	height: "20",
...
var Dt = () => {
	let [s, o] = import_react.useState(document.hidden);
...
var se = (s) => {
	...
	let { invert: o, toast: t, unstyled: n, interacting: h, setHeights: u, visibleToasts: g, heights: b, index: d, toasts: q, expanded: $, removeToast: V, defaultRichColors: Q, closeButton: i, style: O, cancelButtonStyle: K, actionButtonStyle: Z, className: tt = "", descriptionClassName: et = "", duration: X, position: ot, gap: w, loadingIcon: j, expandByDefault: W, classNames: r, icons: I, closeButtonAriaLabel: at = "Close toast", pauseWhenPageIsHidden: k, cn: T } = s, [z, nt] = import_react.useState(!1), [D, H] = import_react.useState(!1), [st, N] = import_react.useState(!1), [M, rt] = import_react.useState(!1), [c, m] = import_react.useState(0), [y, S] = import_react.useState(0), A = import_react.useRef(null), l = import_react.useRef(null), _ = d === 0, J = d + 1 <= g, x = t.type, P = t.dismissible !== !1, Mt = t.className || "", At = t.descriptionClassName || "", G = import_react.useMemo(() => b.findIndex((a) => a.toastId === t.id) || 0, [b, t.id]), Lt = import_react.useMemo(() => {
		var a;
		return (a = t.closeButton) != null ? a : i;
	}, [t.closeButton, i]), mt = import_react.useMemo(() => t.duration || X || Zt, [t.duration, X]), it = import_react.useRef(0), Y = import_react.useRef(0), pt = import_react.useRef(0), F = import_react.useRef(null), [gt, zt] = ot.split("-"), ht = import_react.useMemo(() => b.reduce((a, f, p) => p >= G ? a : a + f.height, 0), [b, G]), bt = Dt(), jt = t.invert || o, lt = x === "loading";
	Y.current = import_react.useMemo(() => G * w + ht, [G, ht]), import_react.useEffect(() => {
		nt(!0);
	...
	let L = import_react.useCallback(() => {
	...
	import_react.useEffect(() => {
		...
		})() : f !== Infinity && (it.current = (/* @__PURE__ */ new Date()).getTime(), a = setTimeout(() => {
			var C;
	...
	}, [u, t.id]), import_react.useEffect(() => {
		t.delete && L();
	}, [L, t.delete]);
	function Yt() {
		return I != null && I.loading ? import_react.createElement("div", {
			className: "sonner-loader",
			"data-visible": x === "loading"
		}, I.loading) : j ? import_react.createElement("div", {
			className: "sonner-loader",
			"data-visible": x === "loading"
		}, j) : import_react.createElement(It, { visible: x === "loading" });
	}
	return import_react.createElement("li", {
		...
		onPointerDown: (a) => {
			lt || !P || (A.current = /* @__PURE__ */ new Date(), m(Y.current), a.target.setPointerCapture(a.pointerId), a.target.tagName !== "BUTTON" && (N(!0), F.current = {
				x: a.clientX,
				y: a.clientY
			}));
		},
	...
	}, Lt && !t.jsx ? import_react.createElement("button", {
		"aria-label": at,
		"data-disabled": lt,
		"data-close-button": !0,
		onClick: lt || !P ? () => {} : () => {
		...
		x2: "18",
		y2: "18"
	}))) : null, t.jsx || import_react.isValidElement(t.title) ? t.jsx || t.title : import_react.createElement(import_react.Fragment, null, x || t.icon || t.promise ? import_react.createElement("div", {
		"data-icon": "",
		className: T(r == null ? void 0 : r.icon, (Tt = t == null ? void 0 : t.classNames) == null ? void 0 : Tt.icon)
	}, t.promise || t.type === "loading" && !t.icon ? t.icon || Yt() : null, t.type !== "loading" ? t.icon || (I == null ? void 0 : I[x]) || Ct(x) : null) : null, import_react.createElement("div", {
		"data-content": "",
	...
	}, t.title), t.description ? import_react.createElement("div", {
		"data-description": "",
		className: T(et, At, r == null ? void 0 : r.description, (Et = t == null ? void 0 : t.classNames) == null ? void 0 : Et.description)
	}, t.description) : null), import_react.isValidElement(t.cancel) ? t.cancel : t.cancel && U(t.cancel) ? import_react.createElement("button", {
		"data-button": !0,
		"data-cancel": !0,
	...
	}, t.cancel.label) : null, import_react.isValidElement(t.action) ? t.action : t.action && U(t.action) ? import_react.createElement("button", {
		"data-button": !0,
		"data-action": !0,
...
var Te = (s) => {
	let { invert: o, position: t = "bottom-right", hotkey: n = ["altKey", "KeyT"], expand: h, closeButton: u, className: g, offset: b, theme: d = "light", richColors: q, duration: $, style: V, visibleToasts: Q = qt, toastOptions: i, dir: O = Ht(), gap: K = ee, loadingIcon: Z, icons: tt, containerAriaLabel: et = "Notifications", pauseWhenPageIsHidden: X, cn: ot = ne } = s, [w, j] = import_react.useState([]), W = import_react.useMemo(() => Array.from(new Set([t].concat(w.filter((c) => c.position).map((c) => c.position)))), [w, t]), [r, I] = import_react.useState([]), [at, k] = import_react.useState(!1), [T, z] = import_react.useState(!1), [nt, D] = import_react.useState(d !== "system" ? d : typeof window != "undefined" && window.matchMedia && window.matchMedia("(prefers-color-scheme: dark)").matches ? "dark" : "light"), H = import_react.useRef(null), st = n.join("+").replace(/Key/g, "").replace(/Digit/g, ""), N = import_react.useRef(null), M = import_react.useRef(!1), rt = import_react.useCallback((c) => {
		var m;
		(m = w.find((y) => y.id === c.id)) != null && m.delete || v.dismiss(c.id), j((y) => y.filter(({ id: S }) => S !== c.id));
	}, [w]);
	return import_react.useEffect(() => v.subscribe((c) => {
		if (c.dismiss) {
	...
	}, [d]), import_react.useEffect(() => {
		w.length <= 1 && k(!1);
	}, [w]), import_react.useEffect(() => {
		let c = (m) => {
			var S, A;
	...
	}, [H.current]), w.length ? import_react.createElement("section", {
		"aria-label": `${et} ${st}`,
		tabIndex: -1
	}, W.map((c, m) => {
		var A;
		let [y, S] = c.split("-");
		return import_react.createElement("ol", {
			key: c,
			dir: O === "auto" ? Ht() : O,
			tabIndex: -1,
			ref: H,
			...
			onBlur: (l) => {
				M.current && !l.currentTarget.contains(l.relatedTarget) && (M.current = !1, N.current && (N.current.focus({ preventScroll: !0 }), N.current = null));
			},
			onFocus: (l) => {
			...
			var J, x;
			return import_react.createElement(se, {
				key: l.id,
				icons: tt,
				index: _,
				toast: l,
...
//#endregion
export { Te as Toaster, Jt as toast, we as useSonner };
